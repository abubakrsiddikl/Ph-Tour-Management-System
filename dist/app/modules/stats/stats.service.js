...
const getUserStats = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const getUserByRolePromise = user_model_1.User.aggregate([
    ...
    const [totalUsers, totalActiveUsers, totalInActiveUsers, totalBlockedUsers, newUsersInLast7Days, newUsersInLast30Days, getUserByRole,] = yield Promise.all([
        totalUsersPromise,
