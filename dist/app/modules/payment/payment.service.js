...
const initPayment = (bookingId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!payment) {
        throw new AppError_1.default(http_status_codes_1.default.NOT_FOUND, "Payment Not Found . You Not Booked this tour .");
    }
...
const successPayment = (query) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (!cloudinaryResult) {
            throw new AppError_1.default(401, "Cloudinary not found");
        }
