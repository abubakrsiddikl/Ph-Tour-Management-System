...
const createBooking = (payload, userId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    //* create Transaction Roll back / Session
    ...
    try {
        ...
        if (!(tour === null || tour === void 0 ? void 0 : tour.costFrom)) {
            throw new AppError_1.default(http_status_codes_1.default.BAD_REQUEST, "No CostFrom Found .");
        }
        ...
        yield session.abortTransaction(); // roll back
        session.endSession();
        throw error;
    }
});
